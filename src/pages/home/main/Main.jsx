        ...
        <section className='main section'>
            {Props.isMobile ? (
                ...
                <div className="main__container container grid">
                    ...
                    <motion.div className="main__container container grid" initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0, transition: { delay: 1.2, duration: 1, ease: [0.42, 0, 0.58, 1] } }} exit={{ opacity: 0, y: -100, x: 10, transition: { delay: 0.3, staggerChildren: 1.5, duration: 1, ease: "easeInOut" }}}>
