...
const TabletMain = ({ navOpen, language }) => {
    ...
    return (
        <motion.div className="main__container container grid" initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0, transition: { delay: 0.2, duration: 0.5, ease: [0.42, 0, 0.58, 1] } }} exit={{ opacity: 0, transition: { delay: 0.1, staggerChildren: 1.5, duration: 0.5, ease: [0.42, 0, 0.58, 1] } }}>
            <div className="main__content" style={{ marginTop: navOpen ? "0" : "0" }}>
                <h1 style={{ fontFamily: language === "ar" ? "Aref Ruqaa" : "", letterSpacing: language === "ar" ? "0" : "0.2rem", fontSize: language === "ar" ? "4rem" : "2.4rem" }} className="main__titlee">{t("hey")}{t("my__name_im")}
                    <span style={{ fontFamily: language === "ar" ? "Aref Ruqaa" : "", letterSpacing: language === "ar" ? "0" : "0.2rem", fontSize: language === "ar" ? "4rem" : "2.4rem" }} className="main__title-color">
                        {t("my__name-first")}
                    </span>
                    <span style={{ fontFamily: language === "ar" ? "Aref Ruqaa" : "", letterSpacing: language === "ar" ? "0" : "0.2rem", fontSize: language === "ar" ? "4rem" : "2.4rem" }}>
                        {t("my__name-last")}
                    </span>
                </h1>
                <h1 style={{ fontFamily: language === "ar" ? "Aref Ruqaa" : "", letterSpacing: language === "ar" ? "0" : "0.2rem", fontSize: language === "ar" ? "4rem" : "2.4rem" }} className="main__subtitle">
                    {t("my__intro")}
                </h1>
            </div>
