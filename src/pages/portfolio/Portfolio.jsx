        ...
        <React.Fragment>
          ...
          <motion.section className="portfolio" ref={(el) => (body = el)}  initial={{ opacity: 0}} animate={{ opacity: 1, y: 0 ,transition: { delay: 0.3, duration: 1, ease: [0.42, 0, 0.58, 1]}}} exit={{ opacity: 0, y: 100 ,transition: { delay: 0.3,  velocity: 2, staggerChildren: 1.5,  duration: 1, ease: [0.42, 0, 0.58, 1]} }}>
            <div className="portfolio__container">
              <div className="menu">
                <motion.div className="text-container" style={{ textAlign: Props.language === "ar" ? "right" : "left", }} initial={{ opacity: 0}} animate={{ opacity: 1, y: 0 ,transition: { delay: 0.3, duration: 1, ease: [0.42, 0, 0.58, 1]}}} exit={{ opacity: 0, y: 100 ,transition: { delay: 0.3,  velocity: 2, staggerChildren: 1.5,  duration: 1, ease: [0.42, 0, 0.58, 1]} }}>
                  ...
                  <motion.div className="scrollbarr"  initial={{ opacity: 0}} animate={{ opacity: 1, y: 0 ,transition: { delay: 0.3, duration: 1, ease: [0.42, 0, 0.58, 1]}}} exit={{ opacity: 0, y: 100 ,transition: { delay: 0.3,  velocity: 2, staggerChildren: 1.5,  duration: 1, ease: [0.42, 0, 0.58, 1]} }}>
          ...
          <motion.section className="portfolio" ref={(el) => (body = el)}  initial={{ opacity: 0}} animate={{ opacity: 1, y: 0 ,transition: { delay: 0.3, duration: 1, ease: [0.42, 0, 0.58, 1]}}} exit={{ opacity: 0, y: 100 ,transition: { delay: 0.3,  velocity: 2, staggerChildren: 1.5,  duration: 1, ease: [0.42, 0, 0.58, 1]} }}>
            <motion.div className="portfolio__container" >
              <motion.div className="menu">
                ...
                <motion.div className="text-container" style={{ textAlign: Props.language === "ar" ? "right" : "left" }}  initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1 }} exit={{ opacity: 0, y: 100 ,transition: { delay: 0.3,  velocity: 2, staggerChildren: 1.5,  duration: 1, ease: [0.42, 0, 0.58, 1]} }}>
                    ...
                    <motion.div className="scrollbarr" initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1 }}  exit={{ opacity: 0, y: 100 ,transition: { delay: 0.3,  velocity: 2, staggerChildren: 1.5,  duration: 1, ease: [0.42, 0, 0.58, 1]} }}>
                      {projectsData.map((item, index) => (
                        <motion.div className="work__title" key={index} onMouseOver={() => handleTextHover(item.id)} onMouseLeave={() => handleTextLeave()}  initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 2 }}  exit={{ opacity: 0, y: 100 ,transition: { delay: 0.3,  velocity: 2, staggerChildren: 1.5,  duration: 1, ease: [0.42, 0, 0.58, 1]} }}>
                          <motion.div className="menu-item-wrapper"  initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1 }} exit={{ opacity: 0, y: 100 ,transition: { delay: 0.3,  velocity: 2, staggerChildren: 1.5,  duration: 1, ease: [0.42, 0, 0.58, 1]} }}>
