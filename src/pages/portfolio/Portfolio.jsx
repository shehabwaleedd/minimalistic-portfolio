    ...
    <>
      {Props.isMobile ? (
        <React.Fragment>
          ...
          <motion.section className="portfolio" ref={(el) => (body = el)}  initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1 }}  exit={{ opacity: 0, y: 100 ,transition: { delay: 0.3,  velocity: 2, staggerChildren: 1.5,  duration: 1, ease: [0.42, 0, 0.58, 1]} }}>
