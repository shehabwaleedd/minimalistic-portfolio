      ...
      {Props.isMobile ? (
        ...
        <>
          <div className="navbar__container" style={{ flexDirection: Props.language === "ar" ? "row-reverse" : "row" }}>
            <div style={{transition: Props.navOpen ? "1.5s" : "1.5s" }}>
              <Link to="/">
                <h1 className={Props.navOpen ? "logo spin" :  Props.isAbout && Props.language === "ar" ? "logoAbout" : "logo"} style={{ fontFamily: Props.language === "ar" ? "Aref Ruqaa" : "", letterSpacing: Props.language === "ar" ? "0" : "0.3rem", fontSize: Props.language === "ar" ? "2rem" : "" }}>{t("my__name")}</h1>
              </Link>
            </div>
            <div className="side__navbar" style={{ flexDirection: Props.language === "ar" ? "row-reverse" : "row", gap: Props.language === "ar" ? "3rem" : "1rem" }}>
              ...
              <div className={`${Props.isAbout ? "menu-toggled" : "menu-toggle"}`} onClick={() => Props.setNavOpen(!Props.navOpen)}>
                <div className={Props.navOpen ? "hamBox hamBoxOpen" : "hamBox"}>
                  <span className={Props.navOpen ? "lineTop spin" : Props.isAbout && Props.language === "ar" ? "lineTopAboutAr" : Props.isAbout ? "lineTopAbout" : "lineTop"}></span>
                  <span className={Props.navOpen ? "lineBottom spin" : Props.isAbout && Props.language === "ar" ? "lineBottomAboutAr" : Props.isAbout ? "lineBottomAbout" : "lineBottom"}></span>
                </div>
              </div>
            </div>
          </div>
