...
//       <motion.div className='toggle__container' layout transition={spring} data-isOn={isOn} >

//           <motion.button onClick={Props.toggleTheme}
//             className={Props.theme === "dark" ? 'toggle__active' : "toggle__dark"}
//             layout transition={spring} >
//             <motion.i class="uil uil-sun" layout transition={spring}>

//             </motion.i>
//           </motion.button>
//           <motion.button onClick={Props.toggleTheme}
//             className={Props.theme === "light" ? ' toggle__active' : "toggle__light"}
//             layout transition={spring} >
//             <motion.i class="uil uil-moon" layout transition={spring}>
